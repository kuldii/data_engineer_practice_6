...
### Practice :
Дано пять наборов данных, которые нужно обработать по следующем алгоритму:<br/>
 ...
 2. Провести анализ набора данных по следующим параметрам:
    ...
    * Объем памяти, который занимает набор данных при загрузке в память
 ...
 8.	Выбрать произвольно 10 колонок для дальнейшем работы, прописав преобразование типов и загрузку только нужных данных на этапе чтения файла. При этом стоит использовать чанки. Сохраните полученный поднабор в отдельном файле.
...
<br/><br/>
Кроме этого, необходимо найти самостоятельно набор данных, размер которого будет составлять минимум 250 МБ. Выполнить вышеуказанные шаги и для этого набора данных.<br/><br/>
